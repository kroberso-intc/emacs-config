...
(let ((colors '(;; Upstream theme color
                ...
                (lazy-hl         "#48493c" "#48493c")
                (diff-bg-red     "#ff8787" "#ff8787")
                (diff-hl-red     "#ff5555" "#ff5555")
                (diff-bg-green       "#82faa0" "#82faa0")
                (diff-hl-green     "#50fa7b" "#50fa7b")))
      (faces '(;; default
               ...
               (lazy-highlight :foreground ,fg2 :background ,lazy-hl)
      ...
      ;; (set-face-foreground 'diff-removed "black" (selected-frame))
               ...
               ;; ediff
               (ediff-current-diff-A :foreground ,dracula-current :background ,diff-bg-red)
               (ediff-current-diff-B :foreground ,dracula-current :background ,diff-bg-green)
               (ediff-fine-diff-A :foreground ,dracula-current :background ,diff-hl-red)
               (ediff-fine-diff-B :foreground ,dracula-current :background ,diff-hl-green)
               (ediff-even-diff-A :foreground ,dracula-fg :background ,bg4)
               (ediff-even-diff-B :foreground ,dracula-fg :background ,bg4)
               (ediff-odd-diff-A  :foreground ,dracula-fg :background ,bg4)
               (ediff-odd-diff-B  :foreground ,dracula-fg :background ,bg4)
               ;; elfeed
               ...
               (magit-section-highlight :background ,bg4 :extend t)
